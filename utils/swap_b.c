...
void	sb(t_stack *stack_data_b, t_id_list *id_list)
{
	...
	stack_data_b->data[stack_data_b->top] = stack_data_b->data[stack_data_b->top - 1];
	...
	temp_id_val = id_list->data_value[stack_data_b->top];
	id_list->data_value[stack_data_b->top] = id_list->data_value[stack_data_b->top - 1];

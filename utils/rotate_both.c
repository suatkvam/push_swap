...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/30 17:34:38 by akivam            #+#    #+#             */
/*   Updated: 2025/09/30 17:34:39 by akivam           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	quiet_ra(stacks->stack_a, stacks->id_list_a);
	quiet_rb(stacks->stack_b, stacks->id_list_b);
	write(1, "rr\n", 3);
}
